...
kubectl set image deployment azure-vote-front azure-vote-front=${resourceLogin}/azure-vote-front:v2
kubectl autoscale deployment azure-vote-front --cpu-percent=50 --min=2 --max=5
...
az aks upgrade --resource-group ${resourceGroup} --name ${clusterName} --kubernetes-version 1.13.5
